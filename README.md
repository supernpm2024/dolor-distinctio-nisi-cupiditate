...
[![Build Status](https://github.com/supernpm2024/dolor-distinctio-nisi-cupiditate/workflows/CI-CD/badge.svg?branch=master)](https://github.com/supernpm2024/dolor-distinctio-nisi-cupiditate/actions)
[![Coverage Status](https://coveralls.io/repos/github/supernpm2024/dolor-distinctio-nisi-cupiditate/badge.svg?branch=master)](https://coveralls.io/github/supernpm2024/dolor-distinctio-nisi-cupiditate)
[![Tested on APIs.guru](https://api.apis.guru/badges/tested_on.svg)](https://apis.guru/browse-apis/)

[![npm](https://img.shields.io/npm/v/@supernpm2024/dolor-distinctio-nisi-cupiditate.svg)](https://www.npmjs.com/package/@supernpm2024/dolor-distinctio-nisi-cupiditate)
[![Dependencies](https://david-dm.org/supernpm2024/dolor-distinctio-nisi-cupiditate.svg)](https://david-dm.org/supernpm2024/dolor-distinctio-nisi-cupiditate)
[![License](https://img.shields.io/npm/l/@supernpm2024/dolor-distinctio-nisi-cupiditate.svg)](LICENSE)
[![Buy us a tree](https://img.shields.io/badge/Treeware-%F0%9F%8C%B3-lightgreen)](https://plant.treeware.earth/supernpm2024/dolor-distinctio-nisi-cupiditate)

[![OS and Browser Compatibility](https://apitools.dev/img/badges/ci-badges-with-ie.svg)](https://github.com/supernpm2024/dolor-distinctio-nisi-cupiditate/actions)
...
- **[Tested](https://github.com/supernpm2024/dolor-distinctio-nisi-cupiditate/actions)** in Node.js and all modern web browsers on Mac, Windows, and Linux
...
```bash
npm install @supernpm2024/dolor-distinctio-nisi-cupiditate
```
...
```javascript
const SwaggerParser = require("@supernpm2024/dolor-distinctio-nisi-cupiditate");
```

When using a transpiler such as [Babel](https://babeljs.io/) or [TypeScript](https://www.typescriptlang.org/), or a bundler such as [Webpack](https://webpack.js.org/) or [Rollup](https://rollupjs.org/), you can use **ECMAScript modules** syntax instead:

```javascript
import * as SwaggerParser from '@supernpm2024/dolor-distinctio-nisi-cupiditate';
```
...
Contributing
--------------------------
I welcome any contributions, enhancements, and bug-fixes.  [Open an issue](https://github.com/supernpm2024/dolor-distinctio-nisi-cupiditate/issues) on GitHub and [submit a pull request](https://github.com/supernpm2024/dolor-distinctio-nisi-cupiditate/pulls).

#### Building/Testing
To build/test the project locally on your computer:

1. __Clone this repo__<br>
`git clone https://github.com/supernpm2024/dolor-distinctio-nisi-cupiditate.git`
...
This package is [Treeware](http://treeware.earth). If you use it in production, then we ask that you [**buy the world a tree**](https://plant.treeware.earth/supernpm2024/dolor-distinctio-nisi-cupiditate) to thank us for our work. By contributing to the Treeware forest you’ll be creating employment for local families and restoring wildlife habitats.
